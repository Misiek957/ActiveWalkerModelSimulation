...
class Elevation:
    ...
    def elev_interpolation(self):
        ...
        xNew = np.arange(int(-areaInterval/2), int(areaInterval/2)+1, interpInterval)  # define the interpolation values
        yNew = np.arange(int(-areaInterval/2), int(areaInterval/2)+1, interpInterval)
